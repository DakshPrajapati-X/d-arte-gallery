    ...
    <div className="w-full min-h-screen px-6 md:px-12 py-32 max-w-[1200px] mx-auto flex flex-col md:flex-row gap-16 md:gap-32">
      ...
      >
        ...
        <div className="space-y-12 text-sm text-muted">
          <div>
            <h2 className="uppercase tracking-widest text-foreground mb-4">Gallery</h2>
            <p>12 Rue de la Paix</p>
            <p>75002 Paris, France</p>
            <p className="mt-4">Visits by appointment only.</p>
          </div>
          <div>
      ...
      >
        <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
          ...
          <button className="py-4 px-12 bg-transparent text-foreground border border-foreground text-xs tracking-[0.2em] uppercase hover:bg-foreground hover:text-background transition-colors">
            Submit
          </button>
        </form>
      </motion.div>
